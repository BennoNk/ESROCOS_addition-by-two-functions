...
void x86_partition_taste_api_manager_has_pending_msg (void *pmy_res, size_t *psize_my_res);
extern void x86_partition_taste_api_PI_manager_has_pending_msg (asn1SccT_Boolean *);
#ifdef __cplusplus
}
#endif
