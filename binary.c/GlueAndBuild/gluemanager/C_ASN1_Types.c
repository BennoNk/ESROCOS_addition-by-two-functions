...
#ifdef __NEED_Geometry_msgs_Point_UPER
int Encode_UPER_Geometry_msgs_Point(void *pBuffer, size_t iMaxBufferSize, const asn1SccGeometry_msgs_Point *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccGeometry_msgs_Point_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Geometry-msgs-Point (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_Geometry_msgs_Point_ACN
int Encode_ACN_Geometry_msgs_Point(void *pBuffer, size_t iMaxBufferSize, asn1SccGeometry_msgs_Point *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccGeometry_msgs_Point_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Geometry-msgs-Point (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_Geometry_msgs_Point_NATIVE
int Encode_NATIVE_Geometry_msgs_Point(void *pBuffer, size_t iMaxBufferSize, const asn1SccGeometry_msgs_Point *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccGeometry_msgs_Point) );
    return sizeof(asn1SccGeometry_msgs_Point);
}
#endif

#ifdef __NEED_Geometry_msgs_Point_UPER
int Decode_UPER_Geometry_msgs_Point(asn1SccGeometry_msgs_Point *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccGeometry_msgs_Point_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode Geometry-msgs-Point (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_Geometry_msgs_Point_ACN
int Decode_ACN_Geometry_msgs_Point(asn1SccGeometry_msgs_Point *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccGeometry_msgs_Point_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_Geometry_msgs_Point_NATIVE
int Decode_NATIVE_Geometry_msgs_Point(asn1SccGeometry_msgs_Point *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccGeometry_msgs_Point *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_Geometry_msgs_Point32_UPER
int Encode_UPER_Geometry_msgs_Point32(void *pBuffer, size_t iMaxBufferSize, const asn1SccGeometry_msgs_Point32 *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccGeometry_msgs_Point32_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Geometry-msgs-Point32 (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_Geometry_msgs_Point32_ACN
int Encode_ACN_Geometry_msgs_Point32(void *pBuffer, size_t iMaxBufferSize, asn1SccGeometry_msgs_Point32 *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccGeometry_msgs_Point32_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Geometry-msgs-Point32 (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_Geometry_msgs_Point32_NATIVE
int Encode_NATIVE_Geometry_msgs_Point32(void *pBuffer, size_t iMaxBufferSize, const asn1SccGeometry_msgs_Point32 *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccGeometry_msgs_Point32) );
    return sizeof(asn1SccGeometry_msgs_Point32);
}
#endif

#ifdef __NEED_Geometry_msgs_Point32_UPER
int Decode_UPER_Geometry_msgs_Point32(asn1SccGeometry_msgs_Point32 *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccGeometry_msgs_Point32_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode Geometry-msgs-Point32 (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_Geometry_msgs_Point32_ACN
int Decode_ACN_Geometry_msgs_Point32(asn1SccGeometry_msgs_Point32 *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccGeometry_msgs_Point32_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_Geometry_msgs_Point32_NATIVE
int Decode_NATIVE_Geometry_msgs_Point32(asn1SccGeometry_msgs_Point32 *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccGeometry_msgs_Point32 *) pBuffer;
    {
        return 0;
    }
}
