...
/*!
 * Store the period time for task vt_manager_clock
 */
  __po_hi_milliseconds (&(period), 2000);
  
/*!
 * \brief Making Periodic Task vt_manager_clock
 *
 ...
 * (x86_partition_vt_manager_clock_k) the second is the period defined in 
 * the AADL model. Third is the task priority ( 10), fourth is the stack 
 * size ( 100000 bytes) and last is the subprogram executed by the task
 */
  __po_hi_create_periodic_task (x86_partition_vt_manager_clock_k, &(period), 10, 100000, 0, vt_manager_clock_job);
