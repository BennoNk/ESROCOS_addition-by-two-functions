...
isSubcomponent('deploymentview::DV','Node1','others','IV_manager','SYSTEM','interfaceview::IV::manager.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_manager','Taste::FunctionName','"manager"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_manager','Taste::APLC_Binding','(reference (x86_partition))','').
isSubcomponent('deploymentview::DV','Node1','others','IV_addition','SYSTEM','interfaceview::IV::addition.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_addition','Taste::FunctionName','"addition"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_addition','Taste::APLC_Binding','(reference (x86_partition))','').
...
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','x86_partition','Actual_Processor_Binding','(reference (x86_linux_dll))','').
isSubcomponent('deploymentview::DV','Node1','others','x86_partition','PROCESS','deploymentview::DV::Node1::x86_partition.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_partition','Taste::coordinates','"128695 94772 192458 139984"','').
...
isSubcomponent('deploymentview::DV','Node1','others','x86_linux_dll','PROCESSOR','ocarina_processors_x86::x86.linux_dll','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux_dll','Taste::coordinates','"120725 81854 200428 146443"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"110762 63400 210391 155670"','').
...
isProperty('NIL','=>','deploymentview::DV','NIL','NIL','NIL','Taste::interfaceView','"addition-by-two-functions_iv.aadl"','').
